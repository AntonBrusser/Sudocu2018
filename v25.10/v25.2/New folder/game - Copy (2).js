...
var matAmbar2recovery = [1,2,3,4,5,6,7,8,9];
var matAmbar4recovery = [1,2,3,4,5,6,7,8,9];

var rowAmbar2recovery = [];
...
for (row = 0; row < 3; row++ )
{
    for(col = 0; col < 3 ; col++)
    {
       ...
       colAmbar1= _.difference(rowAmbar1, [mat1[0][0],mat1[1][0],mat1[2][0]]);
       colAmbar2= _.difference(rowAmbar2, [mat1[1][0],mat1[1][1],mat1[1][2]]);
       colAmbar3= _.difference(rowAmbar3, [mat1[2][0],mat1[2][1],mat1[2][2]]);
    ...
    for(col = 0; col < 3 ; col++)
    {
        L = matAmbar2.length;
            ...
            if (row == 2)
            {
                ...
                num = Math.floor(Math.random()*row3.length-1)+1+1
                

                if (row3[num-1] == undefined)
                    {
                    break;
                    }
           place = row3[num-1];
       ...
       colAmbar4= _.difference(colAmbar4, [mat2[0][0],mat2[1][0],mat2[2][0]]);
       colAmbar5= _.difference(colAmbar5, [mat2[1][0],mat2[1][1],mat2[1][2]]);
       colAmbar6= _.difference(colAmbar6, [mat2[2][0],mat2[2][1],mat2[2][2]]);
...
return mat2;
 ...
 function creatMat2UpsiDown ()
 {
   ...
   rowAmbar2 = rowAmbar2recovery;
   matAmbar2 = matAmbar2recovery;
...
function creatMat3 ()
    {
        ...
        for (row = 0; row < 3; row++ )
        {
            for(col = 0; col < 3 ; col++)
            {
               ...
               colAmbar7= _.difference(rowAmbar7, [mat1[0][0],mat1[1][0],mat1[2][0]]);
               colAmbar8= _.difference(rowAmbar8, [mat1[1][0],mat1[1][1],mat1[1][2]]);
               colAmbar9= _.difference(rowAmbar9, [mat1[2][0],mat1[2][1],mat1[2][2]]);
   ...
   for (row = 0; row < 3; row++ )
   {
       for(col = 0; col < 3 ; col++)
       {
           L = matAmbar4.length;
               ...
               if (col == 0)
                 {
                     var col1 = _.intersection(matAmbar4,colAmbar1);
                     num = Math.floor(Math.random()*col1.length-1)+1+1
                     place = col1[num-1];
                   }
                if (col == 1)
                  {
                   var col2 = _.intersection(matAmbar4,colAmbar2);
                   num = Math.floor(Math.random()*col2.length-1)+1+1   
                   place = col2[num-1];
                   }
           ...
           removeItem3(matAmbar3, place);
          rowAmbar4= _.difference(rowAmbar4, [mat4[0][0],mat4[0][1],mat4[0][2]]);
          rowAmbar5= _.difference(rowAmbar5, [mat4[1][0],mat4[1][1],mat4[1][2]]);
          rowAmbar6= _.difference(rowAmbar6, [ mat4[2][0],mat4[2][1],mat4[2][2]]);
