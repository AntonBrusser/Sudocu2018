        ...
        const pageManager={
            ...
            <div class="container">     
              <div class="jumbotron">
                 ...
                 <header>
                     <h1 class="display-3" >Welcome <span id="userName"></span></h1>
                 </header>
             ...
             <div class="card-header">Create a game</div>
                  <div class="card-body">
                      ...
                      <fieldset>
                          <h4 class="card-title">Choose a level</h4>
                             <div id="difficultyDiv">
                                 <input id="easy" name="game_lvl" type="radio" value="Easy" disabled>   
                                      <label for="easy">Easy</label>     <br>
                                  <input id="medium" name="game_lvl" type="radio" value="Medium" disabled>    
                                      <label for="medium">Medium</label>     <br> 
                                  <input id="hard" name="game_lvl" type="radio" value="Medium" disabled>  
        ...
        */ 
        ...
        const userServer={
            loginRequest: function(loginUser){
                ...
                if(loginUser===null || user.name===null || loginUser.length<1 || (user.userName!==(loginUser.name))){
                    throw "No such user";
                }else if((user.password!==(loginUser.password))){
                    throw "Wrong password";
                }else{
                    gameServer.connect(user);
                    //pageManager.goToPage("gameSetUp",gameSetUp); - SHOULD BE DELETED when gameServer works
                }
        ...
        const gameServer={
            ...
            */
            ...
            /* 
                ...
                @return a sudoku game adapted for the requiered game level.
            */
            resetGame: function(){
                this.gameStatus=false;
            ...
            startGame:function(level){
                ...
                const playBoard=gameGenerator.setGameLevel(level);
                return playBoard;
            },
